...
using static CRM.DTOs.CustomerDTOs.SearchResultCustomerDTO;
...
namespace CRM.API.Endpoints
{
    public static class CustomerEndpoin
    {
        ...
        public static void AddCustomerEndpoints(this WebApplication app)
        {
            ...
            {
                //Crear un objecto ´Customer´ a partir de los datos proporcionados
                ...
                {
                    //Realiza una busqueda de clientes sin contar las filas
                    customers = await customerDAL.Search(customer, skip: customerDTO.Skip, take: customerDTO.Take);
                }

                // Crear un objecto ´SearchResulCustomerDTO´ y agregarlos al resultado
                ...
                // Mapear los resultados a objectos 'CuestomerDTO' y agregarlos al esultado
                customers.ForEach(s =>
                {
            ...
            app.MapGet("/customer/{Id}", async(int id, CustomerDAL customerDAL)=>
            {
                    ...
                    //crear un objecto 'GetIdResultCustomerDTO' para almacenar el resultado
                    ...
                    { 
                     ...
                     //Verificar si se encontro elcliente y devolver la respuesta correspondiente
            ...
            //Configura un endpoint de tipo POST para crear un nuevo cliente
            app.MapPost("/customer", async (CreateCustomerDTO customerDTO, CustomerDAL customerDAL) =>
            {
                ...
                // Intentar crear el cliente y devovel el resultado correspondiente
            ...
            app.MapPut("/customer", async (EditCustomerDTO cutomerDTO, CustomerDAL customerDAL) =>
            {
                // crear un objeto ´Customer´ a patir de los datos proporcionados
                var customer = new Customer
                {
                    Id = cutomerDTO.Id,
                    Name = cutomerDTO.Name,
                    LastName = cutomerDTO.LastName,
                    Address = cutomerDTO.Address
                };

                // Intentar editar el cliene y devolver el resultado correspondiente
            ...
            // Configurar un endpoin de tipo Delete para eliminar un cliente por ID
